namespace Globule
{
	partial class ColorWheelCtrl
	{
		...
		{
            this.m_colorWheel = new Globule.ColorWheel();
            this.m_colorBar = new Globule.HSLColorSlider();
			this.SuspendLayout();
			// 
			// m_colorWheel
			// 
			...
			this.m_colorBar.ValueOrientation = Globule.ColorSlider.eValueOrientation.MinToMax;
			// 
			// ColorWheelCtrl
			// 
